function ProcessSection() {
  return (
    <section className="bg-lightBlack rounded-3xl pb-14">
      ...
      <article className="mb-4 bg-[#FFFFFF1A] text-white p-8 rounded-3xl mx-6">
        <h3 className="text-2xl font-bold">Hire international talent</h3>
        <p className="mt-4 text-sm text-[#FFFFFFA6]">
          Instead of setting up your own entities, experience the speed of HireGO&apos;s automated global hiring. Create
          compliant employment agreements and set up payroll and benefits—in a matter of clicks.
        </p>
      ...
      <article className="mb-4 bg-[#3A5C45] text-white p-8 rounded-3xl mx-6">
      ...
      <article className="mb-4 bg-[#B1D8FC] text-[#000000D9] p-8 rounded-3xl mx-6">
        <h3 className="text-2xl font-bold">Convert contractors to employees</h3>
        <p className="mt-4 text-sm text-[ #000000A6]">
          Assess global worker misclassification risks and compliantly convert contractors to full-timers, all under one
          platform.
        </p>
        <button className="mt-4 font-semibold bg-white rounded-full text-black px-6 py-2 flex items-center">
          Convert contractors
