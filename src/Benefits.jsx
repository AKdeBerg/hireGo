function Benefits() {
  return (
    <section className="bg-[#F5F5F5] p-8 space-y-4">
      <h2 className="text-2xl font-bold text-center px-16 py-8">Take your business to the next level.</h2>
      ...
      <article className="space-y-4">
        ...
        <p className="text-[#00000073] text-sm">
          Save your time, pay your people with automated payroll. Enjoy the benefits of Real Time Information (RTI) and
          take care of workforce planning - all in one simple place.
        </p>
        <button className="bg-white rounded-full flex items-center px-6 py-2 font-semibold border border-solid border-[#000000A6]">
          Payroll Features
          <svg
